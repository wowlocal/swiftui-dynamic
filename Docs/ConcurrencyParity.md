...
scheduler registries. Result-based resume, throwing MainActor evidence,
omitted and arbitrary-source-actor isolation, double-resume and abandonment
policy, escaped-token lifetime, and unsafe continuations remain open.
