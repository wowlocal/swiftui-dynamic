...
Async or argument-bearing actor methods, String-returning or explicitly
nonisolated actor methods, custom actor executors, ambiguity, throwing calls,
and richer results remain cooperative. No actor, `Instance`, closure,
