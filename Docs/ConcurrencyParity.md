...
Focused evidence records one stream, zero consumer suspensions, and empty
stream/task/scope/group/host-operation/scheduler registries. Cancellation
callbacks, bounded buffering, iterator-copy, and lifetime edges remain
fail-closed or open; checked continuations remain open.
