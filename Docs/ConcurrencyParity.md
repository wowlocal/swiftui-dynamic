...
This closes actor subscript getter/setter confinement. Failure/cancellation
exits, replayable mailbox stress, cross-actor and isolated-parameter dispatch,
and the remaining per-feature safety-boundary flips keep M5 open.
