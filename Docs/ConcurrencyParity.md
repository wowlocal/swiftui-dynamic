...
Omitted and arbitrary-source-actor isolation, remaining Result spellings,
checked diagnostics/lifetime, and unsafe continuations remain open.
...
existential-error `Result<T, any Error>` spellings, omitted and arbitrary-
source-actor isolation, diagnostics/lifetime, and unsafe continuations remain
open.
...
spellings, omitted and arbitrary-source-actor isolation, double-resume and
abandonment policy, escaped-token lifetime, and unsafe continuations remain
open.
