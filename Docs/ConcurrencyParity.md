...
getter cases passed. The M5 closing gate remains deferred while other
effectful-accessor failure/cancellation forms and replayable mailbox stress
remain open.
