...
Defaulted/optional isolated-parameter dispatch is covered for source actors,
MainActor, and nil. Arbitrary global actors and the per-feature fail-closed
safety boundary remain open M5 work.
