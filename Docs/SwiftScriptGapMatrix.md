...
methods and property getters now use the typed boundary, but legacy
handwritten gateways, generated property setters, and generated SwiftUI
...
2. **Typed-gateway coverage:** the executable contract layer is landed and
   ...
   complete generated Foundation method/read-property families use it. Move
   generated SwiftUI modifier/constructor tables, Foundation property setters,
   and remaining hand gateways off local extraction; deliberate absorbing
