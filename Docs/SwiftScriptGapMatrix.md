...
2. **Typed-gateway coverage:** the executable contract layer is landed and
   ...
   generated SwiftUI modifier/constructor tables and remaining hand gateways
   off local extraction; deliberate absorbing
