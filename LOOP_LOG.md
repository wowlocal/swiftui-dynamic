# Progress log (append-only; one line per iteration)
# The loop READS only the last ~20 entries (tail -20); the full
# history lives here so LOOP.md stays a bounded algorithm file.
