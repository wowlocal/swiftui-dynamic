final class AsyncThrowingStreamBufferingOldestState: @unchecked Sendable {
    var yieldResults: [String] = []
}

@MainActor
func asyncThrowingStreamBufferingOldestProbe() async -> String {
    let state = AsyncThrowingStreamBufferingOldestState()
