...
// 486 initializer variants across 99 SwiftUI structs.
import SwiftUI
import Symbols
...
extension GeneratedConstructors {
    ...
    register(&t, "AccessibilityCustomContentKey", [ParamSpec(nil, .string, contextualType: "LocalizedStringKey")]) { v in
    ...
    register(&t, "AccessibilityCustomContentKey", [ParamSpec(nil, .string, contextualType: "LocalizedStringKey"), ParamSpec("id", .string, contextualType: "String")]) { v in
    ...
    register(&t, "LabeledContent", [ParamSpec(nil, .string, contextualType: "LocalizedStringKey"), ParamSpec("value", .double, contextualType: "Double"), ParamSpec("format", .sdkEnum("FloatingPointFormatStyle<Double>"), contextualType: "FloatingPointFormatStyle<Double>")]) { v in
        return LabeledContent(LocalizedStringKey(v[0] as! String), value: v[1] as! Double, format: v[2] as! FloatingPointFormatStyle<Double>)
    }
    register(&t, "LabeledContent", [ParamSpec(nil, .string, contextualType: "LocalizedStringKey"), ParamSpec("value", .date, contextualType: "Date"), ParamSpec("format", .sdkEnum("Date.FormatStyle"), contextualType: "Date.FormatStyle")]) { v in
        return LabeledContent(LocalizedStringKey(v[0] as! String), value: v[1] as! Date, format: v[2] as! Date.FormatStyle)
    }
    register(&t, "LabeledContent", [ParamSpec(nil, .string, contextualType: "LocalizedStringKey"), ParamSpec("value", .date, contextualType: "Date"), ParamSpec("format", .sdkEnum("Date.ISO8601FormatStyle"), contextualType: "Date.ISO8601FormatStyle")]) { v in
        return LabeledContent(LocalizedStringKey(v[0] as! String), value: v[1] as! Date, format: v[2] as! Date.ISO8601FormatStyle)
    }
    register(&t, "LabeledContent", [ParamSpec(nil, .string, contextualType: "LocalizedStringKey"), ParamSpec("value", .url, contextualType: "URL"), ParamSpec("format", .sdkEnum("URL.FormatStyle"), contextualType: "URL.FormatStyle")]) { v in
        return LabeledContent(LocalizedStringKey(v[0] as! String), value: v[1] as! URL, format: v[2] as! URL.FormatStyle)
    }
    register(&t, "LabeledContent", [ParamSpec(nil, .string, contextualType: "LocalizedStringKey"), ParamSpec("value", .int, contextualType: "Int"), ParamSpec("format", .sdkEnum("IntegerFormatStyle<Int>"), contextualType: "IntegerFormatStyle<Int>")]) { v in
    ...
    register(&t, "NavigationLink", [ParamSpec(nil, .string, contextualType: "LocalizedStringKey"), ParamSpec("value", .hashable, isOptional: true)]) { v in
