...
extension GeneratedConstructors {
...
#if canImport(UIKit)
    if #available(iOS 26.0, macOS 26.0, *) {
        register(&t, "ConcentricRectangle", [ParamSpec("corners", .sdkEnum("Edge.Corner.Style"), contextualType: "Edge.Corner.Style")]) { v in
            return ConcentricRectangle(corners: v[0] as! Edge.Corner.Style)
        }
    }
#endif
#if canImport(UIKit)
    if #available(iOS 26.0, macOS 26.0, *) {
        register(&t, "ConcentricRectangle", [ParamSpec("uniformBottomCorners", .sdkEnum("Edge.Corner.Style"), contextualType: "Edge.Corner.Style")]) { v in
            return ConcentricRectangle(uniformBottomCorners: v[0] as! Edge.Corner.Style)
        }
    }
#endif
#if canImport(UIKit)
...
#if canImport(UIKit)
    if #available(iOS 26.0, macOS 26.0, *) {
        register(&t, "ConcentricRectangle", [ParamSpec("uniformTrailingCorners", .sdkEnum("Edge.Corner.Style"), contextualType: "Edge.Corner.Style")]) { v in
            return ConcentricRectangle(uniformTrailingCorners: v[0] as! Edge.Corner.Style)
        }
    }
#endif
#if canImport(UIKit)
...
#if canImport(UIKit)
    if #available(iOS 26.0, macOS 26.0, *) {
        register(&t, "ConcentricRectangle", [ParamSpec("corners", .sdkEnum("Edge.Corner.Style"), contextualType: "Edge.Corner.Style"), ParamSpec("isUniform", .bool, contextualType: "Bool")]) { v in
            return ConcentricRectangle(corners: v[0] as! Edge.Corner.Style, isUniform: v[1] as! Bool)
        }
    }
#endif
#if canImport(UIKit)
...
#if canImport(UIKit)
    if #available(iOS 26.0, macOS 26.0, *) {
        register(&t, "ConcentricRectangle", [ParamSpec("topLeadingCorner", .sdkEnum("Edge.Corner.Style"), contextualType: "Edge.Corner.Style"), ParamSpec("bottomTrailingCorner", .sdkEnum("Edge.Corner.Style"), contextualType: "Edge.Corner.Style")]) { v in
            return ConcentricRectangle(topLeadingCorner: v[0] as! Edge.Corner.Style, bottomTrailingCorner: v[1] as! Edge.Corner.Style)
        }
    }
#endif
#if canImport(UIKit)
...
#if canImport(UIKit)
    if #available(iOS 26.0, macOS 26.0, *) {
        register(&t, "ConcentricRectangle", [ParamSpec("uniformLeadingCorners", .sdkEnum("Edge.Corner.Style"), contextualType: "Edge.Corner.Style"), ParamSpec("bottomTrailingCorner", .sdkEnum("Edge.Corner.Style"), contextualType: "Edge.Corner.Style")]) { v in
            return ConcentricRectangle(uniformLeadingCorners: v[0] as! Edge.Corner.Style, bottomTrailingCorner: v[1] as! Edge.Corner.Style)
        }
    }
#endif
#if canImport(UIKit)
    if #available(iOS 26.0, macOS 26.0, *) {
        register(&t, "ConcentricRectangle", [ParamSpec("uniformLeadingCorners", .sdkEnum("Edge.Corner.Style"), contextualType: "Edge.Corner.Style"), ParamSpec("topTrailingCorner", .sdkEnum("Edge.Corner.Style"), contextualType: "Edge.Corner.Style")]) { v in
            return ConcentricRectangle(uniformLeadingCorners: v[0] as! Edge.Corner.Style, topTrailingCorner: v[1] as! Edge.Corner.Style)
        }
    }
#endif
#if canImport(UIKit)
...
#if canImport(UIKit)
    if #available(iOS 26.0, macOS 26.0, *) {
        register(&t, "ConcentricRectangle", [ParamSpec("uniformTrailingCorners", .sdkEnum("Edge.Corner.Style"), contextualType: "Edge.Corner.Style"), ParamSpec("topLeadingCorner", .sdkEnum("Edge.Corner.Style"), contextualType: "Edge.Corner.Style")]) { v in
            return ConcentricRectangle(uniformTrailingCorners: v[0] as! Edge.Corner.Style, topLeadingCorner: v[1] as! Edge.Corner.Style)
        }
    }
#endif
#if canImport(UIKit)
...
#if canImport(UIKit)
    if #available(iOS 26.0, macOS 26.0, *) {
        register(&t, "ConcentricRectangle", [ParamSpec("topLeadingCorner", .sdkEnum("Edge.Corner.Style"), contextualType: "Edge.Corner.Style"), ParamSpec("topTrailingCorner", .sdkEnum("Edge.Corner.Style"), contextualType: "Edge.Corner.Style"), ParamSpec("bottomLeadingCorner", .sdkEnum("Edge.Corner.Style"), contextualType: "Edge.Corner.Style")]) { v in
            return ConcentricRectangle(topLeadingCorner: v[0] as! Edge.Corner.Style, topTrailingCorner: v[1] as! Edge.Corner.Style, bottomLeadingCorner: v[2] as! Edge.Corner.Style)
        }
    }
#endif
#if canImport(UIKit)
...
#if canImport(UIKit)
    if #available(iOS 26.0, macOS 26.0, *) {
        register(&t, "ConcentricRectangle", [ParamSpec("uniformBottomCorners", .sdkEnum("Edge.Corner.Style"), contextualType: "Edge.Corner.Style"), ParamSpec("topLeadingCorner", .sdkEnum("Edge.Corner.Style"), contextualType: "Edge.Corner.Style"), ParamSpec("topTrailingCorner", .sdkEnum("Edge.Corner.Style"), contextualType: "Edge.Corner.Style")]) { v in
            return ConcentricRectangle(uniformBottomCorners: v[0] as! Edge.Corner.Style, topLeadingCorner: v[1] as! Edge.Corner.Style, topTrailingCorner: v[2] as! Edge.Corner.Style)
        }
    }
#endif
#if canImport(UIKit)
...
#if canImport(UIKit)
    if #available(iOS 26.0, macOS 26.0, *) {
        register(&t, "ConcentricRectangle", [ParamSpec("uniformTrailingCorners", .sdkEnum("Edge.Corner.Style"), contextualType: "Edge.Corner.Style"), ParamSpec("topLeadingCorner", .sdkEnum("Edge.Corner.Style"), contextualType: "Edge.Corner.Style"), ParamSpec("bottomLeadingCorner", .sdkEnum("Edge.Corner.Style"), contextualType: "Edge.Corner.Style")]) { v in
            return ConcentricRectangle(uniformTrailingCorners: v[0] as! Edge.Corner.Style, topLeadingCorner: v[1] as! Edge.Corner.Style, bottomLeadingCorner: v[2] as! Edge.Corner.Style)
        }
    }
#endif
#if canImport(UIKit)
    if #available(iOS 26.0, macOS 26.0, *) {
        register(&t, "ConcentricRectangle", [ParamSpec("topLeadingCorner", .sdkEnum("Edge.Corner.Style"), contextualType: "Edge.Corner.Style"), ParamSpec("topTrailingCorner", .sdkEnum("Edge.Corner.Style"), contextualType: "Edge.Corner.Style"), ParamSpec("bottomLeadingCorner", .sdkEnum("Edge.Corner.Style"), contextualType: "Edge.Corner.Style"), ParamSpec("bottomTrailingCorner", .sdkEnum("Edge.Corner.Style"), contextualType: "Edge.Corner.Style")]) { v in
            return ConcentricRectangle(topLeadingCorner: v[0] as! Edge.Corner.Style, topTrailingCorner: v[1] as! Edge.Corner.Style, bottomLeadingCorner: v[2] as! Edge.Corner.Style, bottomTrailingCorner: v[3] as! Edge.Corner.Style)
        }
    }
#endif
    ...
    if #available(iOS 26.0, macOS 26.0, *) {
        register(&t, "DebugReplaceableView", [ParamSpec("erasing", .anyView)]) { v in
            return DebugReplaceableView(erasing: v[0] as! AnyView)
        }
    }
    ...
    if #available(iOS 26.0, macOS 26.0, *) {
        register(&t, "DefaultGlassEffectShape", []) { v in
            return DefaultGlassEffectShape()
        }
    }
    if #available(iOS 26.0, macOS 26.0, *) {
        register(&t, "DefaultToolbarItem", [ParamSpec("kind", .sdkEnum("ToolbarDefaultItemKind"), contextualType: "ToolbarDefaultItemKind")]) { v in
            return DefaultToolbarItem(kind: v[0] as! ToolbarDefaultItemKind)
        }
    }
    if #available(iOS 26.0, macOS 26.0, *) {
        register(&t, "DefaultToolbarItem", [ParamSpec("kind", .sdkEnum("ToolbarDefaultItemKind"), contextualType: "ToolbarDefaultItemKind"), ParamSpec("placement", .sdkEnum("ToolbarItemPlacement"), contextualType: "ToolbarItemPlacement")]) { v in
    ...
    if #available(iOS 26.0, macOS 26.0, *) {
        register(&t, "GlassEffectContainer", [ParamSpec("content", .builder)]) { v in
            let b0 = try generatedBuilder(v[0])
            return GlassEffectContainer(content: { b0 })
        }
    }
    if #available(iOS 26.0, macOS 26.0, *) {
        register(&t, "GlassEffectContainer", [ParamSpec("spacing", .cgFloat, isOptional: true, contextualType: "CGFloat"), ParamSpec("content", .builder)]) { v in
            let b1 = try generatedBuilder(v[1])
    ...
    if #available(iOS 26.0, macOS 26.0, *) {
        register(&t, "ToolbarSpacer", [ParamSpec(nil, .sdkEnum("SpacerSizing"), contextualType: "SpacerSizing")]) { v in
            return ToolbarSpacer(v[0] as! SpacerSizing)
        }
    }
#endif
#if canImport(UIKit)
    if #available(iOS 26.0, macOS 26.0, *) {
        register(&t, "ToolbarSpacer", [ParamSpec(nil, .sdkEnum("SpacerSizing"), contextualType: "SpacerSizing"), ParamSpec("placement", .sdkEnum("ToolbarItemPlacement"), contextualType: "ToolbarItemPlacement")]) { v in
            return ToolbarSpacer(v[0] as! SpacerSizing, placement: v[1] as! ToolbarItemPlacement)
        }
    }
#endif
    ...
    private static func build18(_ t: inout [String: [GeneratedConstructor]]) {
