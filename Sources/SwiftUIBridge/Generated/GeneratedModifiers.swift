...
register(&t, "statusBarHidden", [ParamSpec(nil, .bool, contextualType: "Bool")], requiredImports: ["UIKit"], executesBuilderArguments: false) { view, _ in
    ...
    register(&t, "symbolEffect", [ParamSpec(nil, .sdkProtocolValue(["IndefiniteSymbolEffect", "SymbolEffect"]))]) { view, v in
        let p0 = v[0] as! any IndefiniteSymbolEffect & SymbolEffect
        return AnyView(view.symbolEffect(p0))
    }
    register(&t, "symbolEffect", [ParamSpec(nil, .sdkProtocolValue(["IndefiniteSymbolEffect", "SymbolEffect"])), ParamSpec("isActive", .bool, contextualType: "Bool")]) { view, v in
        let p0 = v[0] as! any IndefiniteSymbolEffect & SymbolEffect
        return AnyView(view.symbolEffect(p0, isActive: v[1] as! Bool))
    }
    register(&t, "symbolEffect", [ParamSpec(nil, .sdkProtocolValue(["IndefiniteSymbolEffect", "SymbolEffect"])), ParamSpec("options", .sdkEnum("SymbolEffectOptions"), contextualType: "SymbolEffectOptions")]) { view, v in
        let p0 = v[0] as! any IndefiniteSymbolEffect & SymbolEffect
        return AnyView(view.symbolEffect(p0, options: v[1] as! SymbolEffectOptions))
    }
    register(&t, "symbolEffect", [ParamSpec(nil, .sdkProtocolValue(["DiscreteSymbolEffect", "SymbolEffect"])), ParamSpec("value", .equatable)]) { view, v in
        let p0 = v[0] as! any DiscreteSymbolEffect & SymbolEffect
        return AnyView(view.symbolEffect(p0, value: v[1] as! String))
    }
    register(&t, "symbolEffect", [ParamSpec(nil, .sdkProtocolValue(["IndefiniteSymbolEffect", "SymbolEffect"])), ParamSpec("options", .sdkEnum("SymbolEffectOptions"), contextualType: "SymbolEffectOptions"), ParamSpec("isActive", .bool, contextualType: "Bool")]) { view, v in
        let p0 = v[0] as! any IndefiniteSymbolEffect & SymbolEffect
        return AnyView(view.symbolEffect(p0, options: v[1] as! SymbolEffectOptions, isActive: v[2] as! Bool))
    }
    register(&t, "symbolEffect", [ParamSpec(nil, .sdkProtocolValue(["DiscreteSymbolEffect", "SymbolEffect"])), ParamSpec("options", .sdkEnum("SymbolEffectOptions"), contextualType: "SymbolEffectOptions"), ParamSpec("value", .equatable)]) { view, v in
        let p0 = v[0] as! any DiscreteSymbolEffect & SymbolEffect
        return AnyView(view.symbolEffect(p0, options: v[1] as! SymbolEffectOptions, value: v[2] as! String))
    }
