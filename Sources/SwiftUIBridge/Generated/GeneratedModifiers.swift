...
// 815 modifier overload variants across 305 names.
import Charts
import SwiftUI
import Symbols
#if canImport(MapKit)
...
extension GeneratedModifiers {
    ...
    register(&t, "accentColor", [ParamSpec(nil, .color, contextualType: "Color")]) { view, v in
        return AnyView(view.accentColor(v[0] as! Color))
    }
    ...
    register(&t, "allowedDynamicRange", [ParamSpec(nil, .sdkEnum("Image.DynamicRange"), contextualType: "Image.DynamicRange")]) { view, v in
        return AnyView(view.allowedDynamicRange(v[0] as! Image.DynamicRange))
    }
    ...
    register(&t, "chartForegroundStyleScale", [ParamSpec("type", .sdkEnum("ScaleType"), contextualType: "ScaleType")]) { view, v in
        return AnyView(view.chartForegroundStyleScale(type: v[0] as! ScaleType))
    }
    }

    private static func build3(_ t: inout [String: [GeneratedOverload]]) {
    register(&t, "chartForegroundStyleScale", [ParamSpec("domain", .sdkProtocolValue("Charts.ScaleDomain"), contextualType: "Charts.ScaleDomain"), ParamSpec("type", .sdkEnum("ScaleType"), contextualType: "ScaleType")]) { view, v in
        let p0 = v[0] as! any Charts.ScaleDomain
        func generatedInvoke<P0: Charts.ScaleDomain>(_ p0: P0) -> AnyView {
            return AnyView(view.chartForegroundStyleScale(domain: p0, type: v[1] as! ScaleType))
        }
        return generatedInvoke(p0)
    }
    ...
    register(&t, "chartSymbolSizeScale", [ParamSpec("type", .sdkEnum("ScaleType"), contextualType: "ScaleType")]) { view, v in
        return AnyView(view.chartSymbolSizeScale(type: v[0] as! ScaleType))
    }
    register(&t, "chartSymbolSizeScale", [ParamSpec("domain", .sdkProtocolValue("Charts.ScaleDomain"), contextualType: "Charts.ScaleDomain"), ParamSpec("type", .sdkEnum("ScaleType"), contextualType: "ScaleType")]) { view, v in
        let p0 = v[0] as! any Charts.ScaleDomain
        func generatedInvoke<P0: Charts.ScaleDomain>(_ p0: P0) -> AnyView {
            return AnyView(view.chartSymbolSizeScale(domain: p0, type: v[1] as! ScaleType))
        }
        return generatedInvoke(p0)
    }
    ...
    register(&t, "chartXScale", [ParamSpec("type", .sdkEnum("ScaleType"), contextualType: "ScaleType")]) { view, v in
        return AnyView(view.chartXScale(type: v[0] as! ScaleType))
    }
    ...
    register(&t, "chartXScale", [ParamSpec("domain", .sdkProtocolValue("Charts.ScaleDomain"), contextualType: "Charts.ScaleDomain"), ParamSpec("type", .sdkEnum("ScaleType"), contextualType: "ScaleType")]) { view, v in
        let p0 = v[0] as! any Charts.ScaleDomain
        func generatedInvoke<P0: Charts.ScaleDomain>(_ p0: P0) -> AnyView {
            return AnyView(view.chartXScale(domain: p0, type: v[1] as! ScaleType))
        }
        return generatedInvoke(p0)
    }
    register(&t, "chartXScale", [ParamSpec("range", .sdkProtocolValue("Charts.PositionScaleRange"), contextualType: "Charts.PositionScaleRange"), ParamSpec("type", .sdkEnum("ScaleType"), contextualType: "ScaleType")]) { view, v in
        let p0 = v[0] as! any Charts.PositionScaleRange
        func generatedInvoke<P0: Charts.PositionScaleRange>(_ p0: P0) -> AnyView {
            return AnyView(view.chartXScale(range: p0, type: v[1] as! ScaleType))
        }
        return generatedInvoke(p0)
    }
    register(&t, "chartXScale", [ParamSpec("domain", .sdkProtocolValue("Charts.ScaleDomain"), contextualType: "Charts.ScaleDomain"), ParamSpec("range", .sdkProtocolValue("Charts.PositionScaleRange"), contextualType: "Charts.PositionScaleRange"), ParamSpec("type", .sdkEnum("ScaleType"), contextualType: "ScaleType")]) { view, v in
        let p0 = v[0] as! any Charts.ScaleDomain
        let p1 = v[1] as! any Charts.PositionScaleRange
        func generatedInvoke<P0: Charts.ScaleDomain, P1: Charts.PositionScaleRange>(_ p0: P0, _ p1: P1) -> AnyView {
            return AnyView(view.chartXScale(domain: p0, range: p1, type: v[2] as! ScaleType))
        }
        return generatedInvoke(p0, p1)
    }
    ...
    register(&t, "chartYScale", [ParamSpec("type", .sdkEnum("ScaleType"), contextualType: "ScaleType")]) { view, v in
        return AnyView(view.chartYScale(type: v[0] as! ScaleType))
    }
    ...
    register(&t, "chartYScale", [ParamSpec("domain", .sdkProtocolValue("Charts.ScaleDomain"), contextualType: "Charts.ScaleDomain"), ParamSpec("type", .sdkEnum("ScaleType"), contextualType: "ScaleType")]) { view, v in
        let p0 = v[0] as! any Charts.ScaleDomain
        func generatedInvoke<P0: Charts.ScaleDomain>(_ p0: P0) -> AnyView {
            return AnyView(view.chartYScale(domain: p0, type: v[1] as! ScaleType))
        }
        return generatedInvoke(p0)
    }
    register(&t, "chartYScale", [ParamSpec("range", .sdkProtocolValue("Charts.PositionScaleRange"), contextualType: "Charts.PositionScaleRange"), ParamSpec("type", .sdkEnum("ScaleType"), contextualType: "ScaleType")]) { view, v in
        let p0 = v[0] as! any Charts.PositionScaleRange
        func generatedInvoke<P0: Charts.PositionScaleRange>(_ p0: P0) -> AnyView {
            return AnyView(view.chartYScale(range: p0, type: v[1] as! ScaleType))
        }
        return generatedInvoke(p0)
    }
    register(&t, "chartYScale", [ParamSpec("domain", .sdkProtocolValue("Charts.ScaleDomain"), contextualType: "Charts.ScaleDomain"), ParamSpec("range", .sdkProtocolValue("Charts.PositionScaleRange"), contextualType: "Charts.PositionScaleRange"), ParamSpec("type", .sdkEnum("ScaleType"), contextualType: "ScaleType")]) { view, v in
        let p0 = v[0] as! any Charts.ScaleDomain
        let p1 = v[1] as! any Charts.PositionScaleRange
        func generatedInvoke<P0: Charts.ScaleDomain, P1: Charts.PositionScaleRange>(_ p0: P0, _ p1: P1) -> AnyView {
            return AnyView(view.chartYScale(domain: p0, range: p1, type: v[2] as! ScaleType))
        }
        return generatedInvoke(p0, p1)
    }
    ...
    register(&t, "contentMargins", [ParamSpec(nil, .edgeSet, contextualType: "Edge.Set"), ParamSpec(nil, .cgFloat, contextualType: "CGFloat"), ParamSpec("for", .sdkEnum("ContentMarginPlacement"), contextualType: "ContentMarginPlacement")]) { view, v in
        return AnyView(view.contentMargins(v[0] as! Edge.Set, v[1] as! CGFloat, for: v[2] as! ContentMarginPlacement))
    }
    ...
    register(&t, "defaultScrollAnchor", [ParamSpec(nil, .unitPoint, contextualType: "UnitPoint"), ParamSpec("for", .sdkEnum("ScrollAnchorRole"), contextualType: "ScrollAnchorRole")]) { view, v in
        return AnyView(view.defaultScrollAnchor(v[0] as! UnitPoint, for: v[1] as! ScrollAnchorRole))
    }
    ...
    register(&t, "disableAutocorrection", [ParamSpec(nil, .bool, contextualType: "Bool")]) { view, v in
        return AnyView(view.disableAutocorrection(v[0] as! Bool))
    }
    ...
    register(&t, "fileExporter", [ParamSpec("isPresented", .bindingBool, contextualType: "Binding<Bool>"), ParamSpec("item", .url), ParamSpec("onCompletion", .syncVoidClosure)]) { view, v in
        return AnyView(view.fileExporter(isPresented: v[0] as! Binding<Bool>, item: v[1] as! URL, onCompletion: generatedSyncVoidClosure(v[2])))
    }
    register(&t, "fileExporter", [ParamSpec("isPresented", .bindingBool, contextualType: "Binding<Bool>"), ParamSpec("item", .url), ParamSpec("onCompletion", .syncVoidClosure), ParamSpec("onCancellation", .action)]) { view, v in
        return AnyView(view.fileExporter(isPresented: v[0] as! Binding<Bool>, item: v[1] as! URL, onCompletion: generatedSyncVoidClosure(v[2]), onCancellation: generatedAction(v[3])))
    }
    register(&t, "fileExporter", [ParamSpec("isPresented", .bindingBool, contextualType: "Binding<Bool>"), ParamSpec("item", .url), ParamSpec("defaultFilename", .string, contextualType: "String"), ParamSpec("onCompletion", .syncVoidClosure)]) { view, v in
        return AnyView(view.fileExporter(isPresented: v[0] as! Binding<Bool>, item: v[1] as! URL, defaultFilename: v[2] as! String, onCompletion: generatedSyncVoidClosure(v[3])))
    }
    register(&t, "fileExporter", [ParamSpec("isPresented", .bindingBool, contextualType: "Binding<Bool>"), ParamSpec("item", .url), ParamSpec("defaultFilename", .string, contextualType: "String"), ParamSpec("onCompletion", .syncVoidClosure), ParamSpec("onCancellation", .action)]) { view, v in
        return AnyView(view.fileExporter(isPresented: v[0] as! Binding<Bool>, item: v[1] as! URL, defaultFilename: v[2] as! String, onCompletion: generatedSyncVoidClosure(v[3]), onCancellation: generatedAction(v[4])))
    }
    ...
    register(&t, "fileMover", [ParamSpec("isPresented", .bindingBool, contextualType: "Binding<Bool>"), ParamSpec("file", .url, contextualType: "URL"), ParamSpec("onCompletion", .syncVoidClosure)]) { view, v in
        return AnyView(view.fileMover(isPresented: v[0] as! Binding<Bool>, file: v[1] as! URL, onCompletion: generatedSyncVoidClosure(v[2])))
    }
    register(&t, "fileMover", [ParamSpec("isPresented", .bindingBool, contextualType: "Binding<Bool>"), ParamSpec("file", .url, contextualType: "URL"), ParamSpec("onCompletion", .syncVoidClosure), ParamSpec("onCancellation", .action)]) { view, v in
        return AnyView(view.fileMover(isPresented: v[0] as! Binding<Bool>, file: v[1] as! URL, onCompletion: generatedSyncVoidClosure(v[2]), onCancellation: generatedAction(v[3])))
    }
    ...
    register(&t, "fontWidth", [ParamSpec(nil, .sdkEnum("Font.Width"), contextualType: "Font.Width")]) { view, v in
        return AnyView(view.fontWidth(v[0] as! Font.Width))
    }
...
register(&t, "hoverEffect", [ParamSpec(nil, .sdkEnum("HoverEffect"), contextualType: "HoverEffect")], requiredImports: ["UIKit"], isDisfavored: true, executesBuilderArguments: false) { view, _ in
    ...
    register(&t, "listItemTint", [ParamSpec(nil, .sdkEnum("ListItemTint"), contextualType: "ListItemTint")]) { view, v in
        return AnyView(view.listItemTint(v[0] as! ListItemTint))
    }
    }
    ...
    register(&t, "listRowSeparatorTint", [ParamSpec(nil, .color, contextualType: "Color"), ParamSpec("edges", .sdkEnum("VerticalEdge.Set"), contextualType: "VerticalEdge.Set")]) { view, v in
        return AnyView(view.listRowSeparatorTint(v[0] as! Color, edges: v[1] as! VerticalEdge.Set))
    }
#if canImport(UIKit)
    register(&t, "listRowSpacing", [ParamSpec(nil, .cgFloat, contextualType: "CGFloat")], requiredImports: ["UIKit"]) { view, v in
...
register(&t, "listRowSpacing", [ParamSpec(nil, .cgFloat, contextualType: "CGFloat")], requiredImports: ["UIKit"], executesBuilderArguments: false) { view, _ in
    ...
    register(&t, "listSectionSeparatorTint", [ParamSpec(nil, .color, contextualType: "Color"), ParamSpec("edges", .sdkEnum("VerticalEdge.Set"), contextualType: "VerticalEdge.Set")]) { view, v in
        return AnyView(view.listSectionSeparatorTint(v[0] as! Color, edges: v[1] as! VerticalEdge.Set))
    }
...
register(&t, "productIconBorder", [], requiredImports: ["StoreKit"], executesBuilderArguments: false) { view, _ in
    ...
    register(&t, "safeAreaInset", [ParamSpec("edge", .sdkEnum("VerticalEdge"), contextualType: "VerticalEdge"), ParamSpec("alignment", .sdkEnum("HorizontalAlignment"), contextualType: "HorizontalAlignment"), ParamSpec("spacing", .cgFloat, contextualType: "CGFloat"), ParamSpec("content", .builder)]) { view, v in
        let b3 = try generatedBuilder(v[3])
    ...
    register(&t, "safeAreaInset", [ParamSpec("edge", .sdkEnum("HorizontalEdge"), contextualType: "HorizontalEdge"), ParamSpec("alignment", .sdkEnum("VerticalAlignment"), contextualType: "VerticalAlignment"), ParamSpec("spacing", .cgFloat, contextualType: "CGFloat"), ParamSpec("content", .builder)]) { view, v in
        let b3 = try generatedBuilder(v[3])
    ...
    register(&t, "searchable", [ParamSpec("text", .bindingString, contextualType: "Binding<String>"), ParamSpec("placement", .sdkEnum("SearchFieldPlacement"), contextualType: "SearchFieldPlacement"), ParamSpec("prompt", .text, contextualType: "Text")]) { view, v in
        return AnyView(view.searchable(text: v[0] as! Binding<String>, placement: v[1] as! SearchFieldPlacement, prompt: v[2] as! Text))
    }
    ...
    register(&t, "searchable", [ParamSpec("text", .bindingString, contextualType: "Binding<String>"), ParamSpec("prompt", .text, contextualType: "Text"), ParamSpec("suggestions", .builder)]) { view, v in
        let b2 = try generatedBuilder(v[2])
        return AnyView(view.searchable(text: v[0] as! Binding<String>, prompt: v[1] as! Text, suggestions: { b2 }))
    }
    ...
    register(&t, "searchable", [ParamSpec("text", .bindingString, contextualType: "Binding<String>"), ParamSpec("isPresented", .bindingBool, contextualType: "Binding<Bool>"), ParamSpec("placement", .sdkEnum("SearchFieldPlacement"), contextualType: "SearchFieldPlacement"), ParamSpec("prompt", .text, contextualType: "Text")]) { view, v in
        return AnyView(view.searchable(text: v[0] as! Binding<String>, isPresented: v[1] as! Binding<Bool>, placement: v[2] as! SearchFieldPlacement, prompt: v[3] as! Text))
    }
    ...
    register(&t, "searchable", [ParamSpec("text", .bindingString, contextualType: "Binding<String>"), ParamSpec("placement", .sdkEnum("SearchFieldPlacement"), contextualType: "SearchFieldPlacement"), ParamSpec("prompt", .text, contextualType: "Text"), ParamSpec("suggestions", .builder)]) { view, v in
        let b3 = try generatedBuilder(v[3])
        return AnyView(view.searchable(text: v[0] as! Binding<String>, placement: v[1] as! SearchFieldPlacement, prompt: v[2] as! Text, suggestions: { b3 }))
    }
    }
...
register(&t, "statusBarHidden", [ParamSpec(nil, .bool, contextualType: "Bool")], requiredImports: ["UIKit"], executesBuilderArguments: false) { view, _ in
    ...
    register(&t, "strikethrough", [ParamSpec("pattern", .sdkEnum("Text.LineStyle.Pattern"), contextualType: "Text.LineStyle.Pattern"), ParamSpec("color", .color, contextualType: "Color")]) { view, v in
        return AnyView(view.strikethrough(pattern: v[0] as! Text.LineStyle.Pattern, color: v[1] as! Color))
    }
    ...
    register(&t, "strikethrough", [ParamSpec(nil, .bool, contextualType: "Bool"), ParamSpec("pattern", .sdkEnum("Text.LineStyle.Pattern"), contextualType: "Text.LineStyle.Pattern"), ParamSpec("color", .color, contextualType: "Color")]) { view, v in
        return AnyView(view.strikethrough(v[0] as! Bool, pattern: v[1] as! Text.LineStyle.Pattern, color: v[2] as! Color))
    }
...
#if canImport(UIKit)
    register(&t, "textInputAutocapitalization", [ParamSpec(nil, .sdkEnum("TextInputAutocapitalization"), contextualType: "TextInputAutocapitalization")], requiredImports: ["UIKit"]) { view, v in
        return AnyView(view.textInputAutocapitalization(v[0] as! TextInputAutocapitalization))
    }
#else
register(&t, "textInputAutocapitalization", [ParamSpec(nil, .sdkEnum("TextInputAutocapitalization"), contextualType: "TextInputAutocapitalization")], requiredImports: ["UIKit"], executesBuilderArguments: false) { view, _ in
    return AnyView(view)
}
#endif
#if canImport(AppKit) && !targetEnvironment(macCatalyst)
    ...
    register(&t, "toolbar", [ParamSpec("removing", .sdkEnum("ToolbarDefaultItemKind"), contextualType: "ToolbarDefaultItemKind")]) { view, v in
        return AnyView(view.toolbar(removing: v[0] as! ToolbarDefaultItemKind))
    }
...
register(&t, "translationTask", [ParamSpec("action", .syncVoidClosure)], requiredImports: ["Translation"], executesBuilderArguments: false) { view, _ in
    ...
    register(&t, "underline", [ParamSpec("pattern", .sdkEnum("Text.LineStyle.Pattern"), contextualType: "Text.LineStyle.Pattern"), ParamSpec("color", .color, contextualType: "Color")]) { view, v in
        return AnyView(view.underline(pattern: v[0] as! Text.LineStyle.Pattern, color: v[1] as! Color))
    }
    ...
    register(&t, "underline", [ParamSpec(nil, .bool, contextualType: "Bool"), ParamSpec("pattern", .sdkEnum("Text.LineStyle.Pattern"), contextualType: "Text.LineStyle.Pattern"), ParamSpec("color", .color, contextualType: "Color")]) { view, v in
        return AnyView(view.underline(v[0] as! Bool, pattern: v[1] as! Text.LineStyle.Pattern, color: v[2] as! Color))
    }
