...
// 272 properties + 136 method variants across AngularGradient, AnyView, AttributedString, AttributedString.Runs.Run, Calendar, CharacterSet, ChartAxisContent, ChartPlotContent, Color, Data, Date, DateBins, DateComponents, DateInterval, DebugReplaceableView, Decimal, DefaultButtonLabel, DefaultDateProgressLabel, DefaultDocumentGroupLaunchActions, DefaultSettingsLinkLabel, DefaultShareLinkLabel, DefaultTabLabel, DefaultWindowVisibilityToggleLabel, Divider, EllipticalGradient, EmptyView, HelpLink, Image, IndexPath, IndexSet, LinearGradient, Locale, Measurement, MeshGradient, OutlineSubgroupChildren, PasteButton, PersonNameComponents, PreviewModifierContent, RadialGradient, Spacer, Subview, SubviewsCollection, SubviewsCollectionSlice, Text, TextEditor, TimeZone, URL, URLComponents, URLQueryItem, URLRequest, UUID.
import Charts
import Foundation
import SwiftUI
...
extension GeneratedMembers {
    static let concreteViewMethodKeys: Set<String> = [
        "Color.mix", "Image.antialiased", "Image.interpolation", "Image.renderingMode", "Image.resizable"
    ]
