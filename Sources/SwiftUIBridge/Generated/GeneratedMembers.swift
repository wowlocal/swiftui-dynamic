...
// 272 properties + 127 method variants across AttributedString, AttributedString.Runs.Run, Calendar, CharacterSet, Data, Date, DateBins, DateComponents, DateInterval, Decimal, IndexPath, IndexSet, Locale, Measurement, PersonNameComponents, TimeZone, URL, URLComponents, URLQueryItem, URLRequest, UUID.
import Charts
import Foundation
