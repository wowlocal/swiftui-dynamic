...
// 272 properties + 228 method variants across AngularGradient, AnyShape, AnyView, AttributedString, AttributedString.Runs.Run, ButtonBorderShape, Calendar, Capsule, CharacterSet, ChartAxisContent, ChartPlotContent, Circle, Color, ConcentricRectangle, ContainerRelativeShape, Data, Date, Date.FormatStyle, Date.ISO8601FormatStyle, DateBins, DateComponents, DateInterval, DebugReplaceableView, Decimal, DefaultButtonLabel, DefaultDateProgressLabel, DefaultDocumentGroupLaunchActions, DefaultGlassEffectShape, DefaultSettingsLinkLabel, DefaultShareLinkLabel, DefaultTabLabel, DefaultWindowVisibilityToggleLabel, Divider, Ellipse, EllipticalGradient, EmptyView, FloatingPointFormatStyle, HelpLink, Image, IndexPath, IndexSet, IntegerFormatStyle, LinearGradient, Locale, Measurement, MeshGradient, OutlineSubgroupChildren, PasteButton, Path, PersonNameComponents, PreviewModifierContent, RadialGradient, Rectangle, RoundedRectangle, Spacer, Subview, SubviewsCollection, SubviewsCollectionSlice, Text, TextEditor, TimeZone, URL, URL.FormatStyle, URLComponents, URLQueryItem, URLRequest, UUID, UnevenRoundedRectangle.
import Charts
import Foundation
import SwiftUI
...
extension GeneratedMembers {
    ...
    private static func buildM0(_ t: inout [String: [GeneratedMemberOverload]]) {
        ...
        registerMethod(&t, "func Color.mix(with p0: Color, by p1: Double) -> Color", [ParamSpec("with", .color), ParamSpec("by", .double)]) { base, v in
            generatedMemberResult((base as! Color).mix(with: v[0] as! Color, by: v[1] as! Double))
        }
        registerMethod(&t, "func Color.mix(with p0: Color, by p1: Double, in p2: Gradient.ColorSpace) -> Color", [ParamSpec("with", .color), ParamSpec("by", .double), ParamSpec("in", .sdkEnum("Gradient.ColorSpace"))]) { base, v in
    ...
    private static func buildM1(_ t: inout [String: [GeneratedMemberOverload]]) {
        ...
        registerMethod(&t, "func Date.FormatStyle.day(_ p0: Date.FormatStyle.Symbol.Day) -> Date.FormatStyle", [ParamSpec(nil, .sdkEnum("Date.FormatStyle.Symbol.Day"))]) { base, v in
        ...
        registerMethod(&t, "func Date.FormatStyle.dayOfYear(_ p0: Date.FormatStyle.Symbol.DayOfYear) -> Date.FormatStyle", [ParamSpec(nil, .sdkEnum("Date.FormatStyle.Symbol.DayOfYear"))]) { base, v in
            generatedMemberResult((base as! Date.FormatStyle).dayOfYear(v[0] as! Date.FormatStyle.Symbol.DayOfYear))
        }
        registerMethod(&t, "func Date.FormatStyle.discreteInput(before p0: Date) -> Date?", [ParamSpec("before", .date)]) { base, v in
            generatedMemberResult((base as! Date.FormatStyle).discreteInput(before: v[0] as! Date))
        }
        registerMethod(&t, "func Date.FormatStyle.discreteInput(after p0: Date) -> Date?", [ParamSpec("after", .date)]) { base, v in
        ...
        registerMethod(&t, "func Date.FormatStyle.era(_ p0: Date.FormatStyle.Symbol.Era) -> Date.FormatStyle", [ParamSpec(nil, .sdkEnum("Date.FormatStyle.Symbol.Era"))]) { base, v in
            generatedMemberResult((base as! Date.FormatStyle).era(v[0] as! Date.FormatStyle.Symbol.Era))
        }
        registerMethod(&t, "func Date.FormatStyle.format(_ p0: Date) -> String", [ParamSpec(nil, .date)]) { base, v in
        ...
        registerMethod(&t, "func Date.FormatStyle.hour(_ p0: Date.FormatStyle.Symbol.Hour) -> Date.FormatStyle", [ParamSpec(nil, .sdkEnum("Date.FormatStyle.Symbol.Hour"))]) { base, v in
            generatedMemberResult((base as! Date.FormatStyle).hour(v[0] as! Date.FormatStyle.Symbol.Hour))
        }
        registerMethod(&t, "func Date.FormatStyle.input(before p0: Date) -> Date?", [ParamSpec("before", .date)]) { base, v in
            generatedMemberResult((base as! Date.FormatStyle).input(before: v[0] as! Date))
        }
        registerMethod(&t, "func Date.FormatStyle.input(after p0: Date) -> Date?", [ParamSpec("after", .date)]) { base, v in
            generatedMemberResult((base as! Date.FormatStyle).input(after: v[0] as! Date))
        }
        registerMethod(&t, "func Date.FormatStyle.locale(_ p0: Locale) -> Date.FormatStyle", [ParamSpec(nil, .sdkEnum("Locale"))]) { base, v in
        ...
        registerMethod(&t, "func Date.FormatStyle.minute(_ p0: Date.FormatStyle.Symbol.Minute) -> Date.FormatStyle", [ParamSpec(nil, .sdkEnum("Date.FormatStyle.Symbol.Minute"))]) { base, v in
        ...
        registerMethod(&t, "func Date.FormatStyle.month(_ p0: Date.FormatStyle.Symbol.Month) -> Date.FormatStyle", [ParamSpec(nil, .sdkEnum("Date.FormatStyle.Symbol.Month"))]) { base, v in
        ...
        registerMethod(&t, "func Date.FormatStyle.quarter(_ p0: Date.FormatStyle.Symbol.Quarter) -> Date.FormatStyle", [ParamSpec(nil, .sdkEnum("Date.FormatStyle.Symbol.Quarter"))]) { base, v in
        ...
        registerMethod(&t, "func Date.FormatStyle.second(_ p0: Date.FormatStyle.Symbol.Second) -> Date.FormatStyle", [ParamSpec(nil, .sdkEnum("Date.FormatStyle.Symbol.Second"))]) { base, v in
            generatedMemberResult((base as! Date.FormatStyle).second(v[0] as! Date.FormatStyle.Symbol.Second))
        }
        registerMethod(&t, "func Date.FormatStyle.secondFraction(_ p0: Date.FormatStyle.Symbol.SecondFraction) -> Date.FormatStyle", [ParamSpec(nil, .sdkEnum("Date.FormatStyle.Symbol.SecondFraction"))]) { base, v in
        ...
        registerMethod(&t, "func Date.FormatStyle.timeZone(_ p0: Date.FormatStyle.Symbol.TimeZone) -> Date.FormatStyle", [ParamSpec(nil, .sdkEnum("Date.FormatStyle.Symbol.TimeZone"))]) { base, v in
        ...
        registerMethod(&t, "func Date.FormatStyle.week(_ p0: Date.FormatStyle.Symbol.Week) -> Date.FormatStyle", [ParamSpec(nil, .sdkEnum("Date.FormatStyle.Symbol.Week"))]) { base, v in
        ...
        registerMethod(&t, "func Date.FormatStyle.weekday(_ p0: Date.FormatStyle.Symbol.Weekday) -> Date.FormatStyle", [ParamSpec(nil, .sdkEnum("Date.FormatStyle.Symbol.Weekday"))]) { base, v in
        ...
        registerMethod(&t, "func Date.FormatStyle.year(_ p0: Date.FormatStyle.Symbol.Year) -> Date.FormatStyle", [ParamSpec(nil, .sdkEnum("Date.FormatStyle.Symbol.Year"))]) { base, v in
            generatedMemberResult((base as! Date.FormatStyle).year(v[0] as! Date.FormatStyle.Symbol.Year))
        }
        registerMethod(&t, "func Date.ISO8601FormatStyle.dateSeparator(_ p0: Date.ISO8601FormatStyle.DateSeparator) -> Date.ISO8601FormatStyle", [ParamSpec(nil, .sdkEnum("Date.ISO8601FormatStyle.DateSeparator"))]) { base, v in
            generatedMemberResult((base as! Date.ISO8601FormatStyle).dateSeparator(v[0] as! Date.ISO8601FormatStyle.DateSeparator))
        }
        registerMethod(&t, "func Date.ISO8601FormatStyle.dateTimeSeparator(_ p0: Date.ISO8601FormatStyle.DateTimeSeparator) -> Date.ISO8601FormatStyle", [ParamSpec(nil, .sdkEnum("Date.ISO8601FormatStyle.DateTimeSeparator"))]) { base, v in
        ...
        registerMethod(&t, "func Date.ISO8601FormatStyle.format(_ p0: Date) -> String", [ParamSpec(nil, .date)]) { base, v in
        ...
        registerMethod(&t, "func Date.ISO8601FormatStyle.time(includingFractionalSeconds p0: Bool) -> Date.ISO8601FormatStyle", [ParamSpec("includingFractionalSeconds", .bool)]) { base, v in
    ...
    private static func buildM2(_ t: inout [String: [GeneratedMemberOverload]]) {
        registerMethod(&t, "func Date.ISO8601FormatStyle.timeSeparator(_ p0: Date.ISO8601FormatStyle.TimeSeparator) -> Date.ISO8601FormatStyle", [ParamSpec(nil, .sdkEnum("Date.ISO8601FormatStyle.TimeSeparator"))]) { base, v in
            generatedMemberResult((base as! Date.ISO8601FormatStyle).timeSeparator(v[0] as! Date.ISO8601FormatStyle.TimeSeparator))
        }
        registerMethod(&t, "func Date.ISO8601FormatStyle.timeZone(separator p0: Date.ISO8601FormatStyle.TimeZoneSeparator) -> Date.ISO8601FormatStyle", [ParamSpec("separator", .sdkEnum("Date.ISO8601FormatStyle.TimeZoneSeparator"))]) { base, v in
        ...
        registerMethod(&t, "func Date.ISO8601FormatStyle.timeZoneSeparator(_ p0: Date.ISO8601FormatStyle.TimeZoneSeparator) -> Date.ISO8601FormatStyle", [ParamSpec(nil, .sdkEnum("Date.ISO8601FormatStyle.TimeZoneSeparator"))]) { base, v in
        ...
        registerMethod(&t, "func Image.interpolation(_ p0: Image.Interpolation) -> Image", [ParamSpec(nil, .sdkEnum("Image.Interpolation"))]) { base, v in
            generatedMemberResult((base as! Image).interpolation(v[0] as! Image.Interpolation))
        }
        registerMethod(&t, "func Image.renderingMode(_ p0: Image.TemplateRenderingMode) -> Image", [ParamSpec(nil, .sdkEnum("Image.TemplateRenderingMode"))]) { base, v in
        ...
        registerMethod(&t, "func Image.resizable(resizingMode p0: Image.ResizingMode) -> Image", [ParamSpec("resizingMode", .sdkEnum("Image.ResizingMode"))]) { base, v in
            generatedMemberResult((base as! Image).resizable(resizingMode: v[0] as! Image.ResizingMode))
        }
        registerMethod(&t, "func Image.resizable(capInsets p0: EdgeInsets) -> Image", [ParamSpec("capInsets", .edgeInsets)]) { base, v in
            generatedMemberResult((base as! Image).resizable(capInsets: v[0] as! EdgeInsets))
        }
        registerMethod(&t, "func Image.resizable(capInsets p0: EdgeInsets, resizingMode p1: Image.ResizingMode) -> Image", [ParamSpec("capInsets", .edgeInsets), ParamSpec("resizingMode", .sdkEnum("Image.ResizingMode"))]) { base, v in
    ...
    private static func buildM4(_ t: inout [String: [GeneratedMemberOverload]]) {
        ...
        registerMethod(&t, "func Path.intersection(_ p0: Path) -> Path", [ParamSpec(nil, .nativeSwiftUIValue("Path"))]) { base, v in
            generatedMemberResult((base as! Path).intersection(v[0] as! Path))
        }
        registerMethod(&t, "func Path.intersection(_ p0: Path, eoFill p1: Bool) -> Path", [ParamSpec(nil, .nativeSwiftUIValue("Path")), ParamSpec("eoFill", .bool)]) { base, v in
            generatedMemberResult((base as! Path).intersection(v[0] as! Path, eoFill: v[1] as! Bool))
        }
        registerMethod(&t, "func Path.lineIntersection(_ p0: Path) -> Path", [ParamSpec(nil, .nativeSwiftUIValue("Path"))]) { base, v in
            generatedMemberResult((base as! Path).lineIntersection(v[0] as! Path))
        }
        registerMethod(&t, "func Path.lineIntersection(_ p0: Path, eoFill p1: Bool) -> Path", [ParamSpec(nil, .nativeSwiftUIValue("Path")), ParamSpec("eoFill", .bool)]) { base, v in
            generatedMemberResult((base as! Path).lineIntersection(v[0] as! Path, eoFill: v[1] as! Bool))
        }
        registerMethod(&t, "func Path.lineSubtraction(_ p0: Path) -> Path", [ParamSpec(nil, .nativeSwiftUIValue("Path"))]) { base, v in
            generatedMemberResult((base as! Path).lineSubtraction(v[0] as! Path))
        }
        registerMethod(&t, "func Path.lineSubtraction(_ p0: Path, eoFill p1: Bool) -> Path", [ParamSpec(nil, .nativeSwiftUIValue("Path")), ParamSpec("eoFill", .bool)]) { base, v in
        ...
        registerMethod(&t, "func Path.normalized(eoFill p0: Bool) -> Path", [ParamSpec("eoFill", .bool)]) { base, v in
            generatedMemberResult((base as! Path).normalized(eoFill: v[0] as! Bool))
        }
        registerMethod(&t, "func Path.offsetBy(dx p0: CGFloat, dy p1: CGFloat) -> Path", [ParamSpec("dx", .cgFloat), ParamSpec("dy", .cgFloat)]) { base, v in
            generatedMemberResult((base as! Path).offsetBy(dx: v[0] as! CGFloat, dy: v[1] as! CGFloat))
        }
        registerMethod(&t, "func Path.strokedPath(_ p0: StrokeStyle) -> Path", [ParamSpec(nil, .nativeSwiftUIValue("StrokeStyle"))]) { base, v in
            generatedMemberResult((base as! Path).strokedPath(v[0] as! StrokeStyle))
        }
        registerMethod(&t, "func Path.subtracting(_ p0: Path) -> Path", [ParamSpec(nil, .nativeSwiftUIValue("Path"))]) { base, v in
            generatedMemberResult((base as! Path).subtracting(v[0] as! Path))
        }
        registerMethod(&t, "func Path.subtracting(_ p0: Path, eoFill p1: Bool) -> Path", [ParamSpec(nil, .nativeSwiftUIValue("Path")), ParamSpec("eoFill", .bool)]) { base, v in
            generatedMemberResult((base as! Path).subtracting(v[0] as! Path, eoFill: v[1] as! Bool))
        }
        registerMethod(&t, "func Path.symmetricDifference(_ p0: Path) -> Path", [ParamSpec(nil, .nativeSwiftUIValue("Path"))]) { base, v in
            generatedMemberResult((base as! Path).symmetricDifference(v[0] as! Path))
        }
        registerMethod(&t, "func Path.symmetricDifference(_ p0: Path, eoFill p1: Bool) -> Path", [ParamSpec(nil, .nativeSwiftUIValue("Path")), ParamSpec("eoFill", .bool)]) { base, v in
            generatedMemberResult((base as! Path).symmetricDifference(v[0] as! Path, eoFill: v[1] as! Bool))
        }
        registerMethod(&t, "func Path.trimmedPath(from p0: CGFloat, to p1: CGFloat) -> Path", [ParamSpec("from", .cgFloat), ParamSpec("to", .cgFloat)]) { base, v in
            generatedMemberResult((base as! Path).trimmedPath(from: v[0] as! CGFloat, to: v[1] as! CGFloat))
        }
        registerMethod(&t, "func Path.union(_ p0: Path) -> Path", [ParamSpec(nil, .nativeSwiftUIValue("Path"))]) { base, v in
            generatedMemberResult((base as! Path).union(v[0] as! Path))
        }
        registerMethod(&t, "func Path.union(_ p0: Path, eoFill p1: Bool) -> Path", [ParamSpec(nil, .nativeSwiftUIValue("Path")), ParamSpec("eoFill", .bool)]) { base, v in
    ...
    private static func buildM5(_ t: inout [String: [GeneratedMemberOverload]]) {
        ...
        registerMethod(&t, "func URL.FormatStyle.format(_ p0: URL) -> String", [ParamSpec(nil, .url)]) { base, v in
        ...
        registerMethod(&t, "func URL.FormatStyle.fragment(_ p0: URL.FormatStyle.ComponentDisplayOption) -> URL.FormatStyle", [ParamSpec(nil, .sdkEnum("URL.FormatStyle.ComponentDisplayOption"))]) { base, v in
        ...
        registerMethod(&t, "func URL.FormatStyle.host(_ p0: URL.FormatStyle.HostDisplayOption) -> URL.FormatStyle", [ParamSpec(nil, .sdkEnum("URL.FormatStyle.HostDisplayOption"))]) { base, v in
        ...
        registerMethod(&t, "func URL.FormatStyle.password(_ p0: URL.FormatStyle.ComponentDisplayOption) -> URL.FormatStyle", [ParamSpec(nil, .sdkEnum("URL.FormatStyle.ComponentDisplayOption"))]) { base, v in
        ...
        registerMethod(&t, "func URL.FormatStyle.path(_ p0: URL.FormatStyle.ComponentDisplayOption) -> URL.FormatStyle", [ParamSpec(nil, .sdkEnum("URL.FormatStyle.ComponentDisplayOption"))]) { base, v in
        ...
        registerMethod(&t, "func URL.FormatStyle.port(_ p0: URL.FormatStyle.ComponentDisplayOption) -> URL.FormatStyle", [ParamSpec(nil, .sdkEnum("URL.FormatStyle.ComponentDisplayOption"))]) { base, v in
        ...
        registerMethod(&t, "func URL.FormatStyle.query(_ p0: URL.FormatStyle.ComponentDisplayOption) -> URL.FormatStyle", [ParamSpec(nil, .sdkEnum("URL.FormatStyle.ComponentDisplayOption"))]) { base, v in
        ...
        registerMethod(&t, "func URL.FormatStyle.scheme(_ p0: URL.FormatStyle.ComponentDisplayOption) -> URL.FormatStyle", [ParamSpec(nil, .sdkEnum("URL.FormatStyle.ComponentDisplayOption"))]) { base, v in
        ...
        registerMethod(&t, "func URL.FormatStyle.user(_ p0: URL.FormatStyle.ComponentDisplayOption) -> URL.FormatStyle", [ParamSpec(nil, .sdkEnum("URL.FormatStyle.ComponentDisplayOption"))]) { base, v in
...
extension GeneratedMembers {
    ...
    /// Concrete value constructors selected transitively from throwing
    /// initializer parameter types in Foundation.swiftinterface.
    static let nativeValueConstructors: [String: GeneratedConstructorSet] = [
        ...
        "Decimal.FormatStyle.Currency": GeneratedConstructorSet([
            ...
            GeneratedConstructor(params: [ParamSpec("code", .string), ParamSpec("locale", .sdkEnum("Locale"))]) { values in
                Decimal.FormatStyle.Currency(code: (values[0] as! String), locale: (values[1] as! Locale))
            },
        ]),
        "Decimal.FormatStyle.Percent": GeneratedConstructorSet([
            GeneratedConstructor(params: []) { values in
                Decimal.FormatStyle.Percent()
            },
            GeneratedConstructor(params: [ParamSpec("locale", .sdkEnum("Locale"))]) { values in
                Decimal.FormatStyle.Percent(locale: (values[0] as! Locale))
            },
        ]),
    ]
