...
extension GeneratedMembers {
    static let concreteViewMethodKeys: Set<String> = [
        "Color.mix", "Image.antialiased", "Image.interpolation", "Image.renderingMode", "Image.resizable", "Path.normalized", "Path.offsetBy", "Path.trimmedPath"
    ]
