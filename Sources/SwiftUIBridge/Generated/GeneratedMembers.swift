...
// 272 properties + 153 method variants across AngularGradient, AnyShape, AnyView, AttributedString, AttributedString.Runs.Run, ButtonBorderShape, Calendar, Capsule, CharacterSet, ChartAxisContent, ChartPlotContent, Circle, Color, ConcentricRectangle, ContainerRelativeShape, Data, Date, DateBins, DateComponents, DateInterval, DebugReplaceableView, Decimal, DefaultButtonLabel, DefaultDateProgressLabel, DefaultDocumentGroupLaunchActions, DefaultGlassEffectShape, DefaultSettingsLinkLabel, DefaultShareLinkLabel, DefaultTabLabel, DefaultWindowVisibilityToggleLabel, Divider, Ellipse, EllipticalGradient, EmptyView, HelpLink, Image, IndexPath, IndexSet, LinearGradient, Locale, Measurement, MeshGradient, OutlineSubgroupChildren, PasteButton, Path, PersonNameComponents, PreviewModifierContent, RadialGradient, Rectangle, RoundedRectangle, Spacer, Subview, SubviewsCollection, SubviewsCollectionSlice, Text, TextEditor, TimeZone, URL, URLComponents, URLQueryItem, URLRequest, UUID, UnevenRoundedRectangle.
import Charts
import Foundation
import SwiftUI
...
extension GeneratedMembers {
    ...
    static let runtimeNestedTypeNames: [String: String] = ["CharacterView": "AttributedString.CharacterView", "Run": "AttributedString.Runs.Run", "Runs": "AttributedString.Runs", "UTF16View": "AttributedString.UTF16View", "UTF8View": "AttributedString.UTF8View", "UnicodeScalarView": "AttributedString.UnicodeScalarView"]
